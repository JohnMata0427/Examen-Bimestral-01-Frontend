    ...
    return (
        <div className="flex flex-col items-center bg-gradient-to-r from-[rgba(238, 174, 202, 1) 0%] to-[rgba(148, 187, 233, 1) 100%]">
            ...
            <ul className="grid grid-cols-7 flex-wrap list-none">
                <li className="flex size-40 m-1 flex-col rounded p-1 font-light box-border bg-[rgba(255, 255, 255, 0.25)] shadow-xl border-1 "><time datetime="2022-02-01">1</time>Dark Chocolate Day</li>
